...
{
    internal class EDSSStandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            //public static GUIContent mixSetLabel = new GUIContent("Mix Set");
            ...
            //public static string mixingMode = "Mixing Mode";
            public static string advancedText = "Advanced Options";
            public static readonly string[] blendNames = Enum.GetNames(typeof(BlendMode));
            //public static readonly string[] mixNames = Enum.GetNames(typeof(DetailMixes));
        }

        MaterialProperty blendMode = null;
        //MaterialProperty mixMode = null;
        ...
        //MaterialProperty mixDetailColors = null;
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                //m_MaterialEditor.TexturePropertySingleLine(Styles.detailSpecText, detailSpecMap);
                m_MaterialEditor.TexturePropertySingleLine(Styles.detailNormalMapText, detailNormalMap, detailNormalMapScale);
                m_MaterialEditor.TextureScaleOffsetProperty(detailAlbedoMap);
                //m_MaterialEditor.TextureScaleOffsetProperty(detailSpecMap);
                DoSpecularMetallicDetailArea();
                m_MaterialEditor.ShaderProperty(uvSetSecondary, Styles.uvSetLabel.text);
                //m_MaterialEditor.ShaderProperty(mixDetailColors, Styles.mixSetLabel.text);
        ...
        /*
        void MixModePopup() {
            EditorGUI.showMixedValue = mixMode.hasMixedValue;
            var mode = (DetailMixes)mixMode.floatValue;

            EditorGUI.BeginChangeCheck();
            mode = (DetailMixes)EditorGUILayout.Popup(Styles.mixingMode, (int)mode, Styles.mixNames);
            if (EditorGUI.EndChangeCheck()) {
                m_MaterialEditor.RegisterPropertyChangeUndo("Mix Mode");
                mixMode.floatValue = (float)mode;
            }
        ...
        static void SetMaterialKeywords(Material material, WorkflowMode workflowMode) {
            ...
            if (workflowMode == WorkflowMode.Specular) { 
                ...
                SetKeyword(material, "_SPECDETAILMAP", material.GetTexture("_DetailSpecMap"));
            }
            ...
            /*
            switch ((DetailMixes)material.GetFloat("_Mix")) {
                case DetailMixes.MULX2:
                    SetKeyword(material, "_DETAIL_MULX2", material.GetTexture("_DetailAlbedoMap") || material.GetTexture("_DetailNormalMap"));
                    break;
                case DetailMixes.MUL:
                    SetKeyword(material, "_DETAIL_MUL", material.GetTexture("_DetailAlbedoMap") || material.GetTexture("_DetailNormalMap"));
                    break;
                case DetailMixes.ADD:
                    SetKeyword(material, "_DETAIL_ADD", material.GetTexture("_DetailAlbedoMap") || material.GetTexture("_DetailNormalMap"));
                    break;
                case DetailMixes.LERP:
                    SetKeyword(material, "_DETAIL_LERP", material.GetTexture("_DetailAlbedoMap") || material.GetTexture("_DetailNormalMap"));
                    break;
            }*/
